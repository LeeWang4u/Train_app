...
//            int firstDayOfWeek = calendar.get(Calendar.DAY_OF_WEEK) - 2; // Điều chỉnh để T.2 là 0
...
//
//                if (day.before(today)) {
//                    tvDate.setEnabled(false); // Vô hiệu hóa ngày trong quá khứ
//                    tvDate.setTextColor(context.getResources().getColor(android.R.color.darker_gray));
//                } else {
//                    tvDate.setEnabled(true);
//                    tvDate.setTextColor(context.getResources().getColor(android.R.color.black));
//
//                    // Kiểm tra ngày có được chọn không
...
//                            onDateSelectedListener.onDateSelected(selectedDate);
//                            notifyDataSetChanged(); // Cập nhật giao diện GridView
//                        }
//                    });
//                }
//            }
